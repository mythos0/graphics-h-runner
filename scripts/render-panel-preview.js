...
const STUB = `<script>function acquireVsCodeApi(){return {postMessage:function(){},getState:function(){return {}},setState:function(){}};}</script>`;
...
function make(status, name) {
  ...
  html = html.replace('<script nonce="previewnonce">', STUB + '<script nonce="previewnonce">');
