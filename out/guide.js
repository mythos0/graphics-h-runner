...
./configure && make && sudo make install</pre>
    ...
    <code>SDL_BGI_RATE=auto</code> or call <code>refresh()</code> after drawing — newer SDL_bgi defers screen updates in fast mode.</p>`, linuxActive)}

  ${section(' macOS — SDL_bgi via Homebrew SDL2', `<ol>
